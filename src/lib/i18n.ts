...
export const translations = {
  de: {
    ...
    stoss: "Stoß",
    retour: "Retour",
    settingsAvatar: "Profilbild",
    settingsAvatarHint: "Wähle ein Profilbild oder lade ein eigenes hoch. Es wird deinem Mitspieler im Mehrspieler-Modus angezeigt.",
    avatarChoose: "Bild wählen",
    avatarUpload: "Eigenes Bild",
    avatarUploadFailed: "Das Bild konnte nicht geladen werden.",
    avatarReset: "Standard",
  ...
  en: {
    ...
    settingsAvatarHint: "Pick a profile picture or upload your own. It is shown to your fellow player in multiplayer.",
    avatarChoose: "Choose a picture",
    avatarUpload: "Custom picture",
    avatarUploadFailed: "The picture could not be loaded.",
    avatarReset: "Default",
