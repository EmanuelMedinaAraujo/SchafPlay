...
export const translations = {
  de: {
    ...
    hostIntro: "Sag deinem Mitspieler diesen Spiel-Code – mehr braucht es nicht.",
    joinIntro: "Gib den Spiel-Code des Hosts ein.",
    yourCode: "Dein Spiel-Code",
    creatingCode: "Erzeuge Spiel-Code …",
    enterCode: "Spiel-Code",
    join: "Beitreten",
    copy: "Kopieren",
    copied: "Kopiert!",
    ...
    invalidCode: "Code nicht gefunden. Bitte prüfen und erneut versuchen.",
    ...
    reconnectHint: "Der Host bekommt einen neuen Spiel-Code – der Mitspieler gibt ihn ein. Der Spielstand bleibt erhalten.",
    rules: "Regeln",
  ...
  en: {
    ...
    hostGame: "Host game",
    joinGame: "Join game",
    hostIntro: "Tell your partner this game code – that's all it takes.",
    joinIntro: "Enter the host's game code.",
    yourCode: "Your game code",
    creatingCode: "Creating game code …",
    enterCode: "Game code",
    join: "Join",
    copy: "Copy",
    copied: "Copied!",
    ...
    failed: "Failed",
    invalidCode: "Code not found. Please check it and try again.",
    ...
    reconnectHint: "The host gets a fresh game code – the partner enters it. The game state is preserved.",
    rules: "Rules",
