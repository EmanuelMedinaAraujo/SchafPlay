...
export const translations = {
  de: {
    ...
    hostIntro: "Erzeuge einen Code, schicke ihn deinem Mitspieler und füge dessen Antwort ein.",
    joinIntro: "Füge den Code des Hosts ein und schicke ihm deinen Antwort-Code zurück.",
    offerCode: "Dein Einladungs-Code",
    answerCode: "Dein Antwort-Code",
    generateOffer: "Einladungs-Code erzeugen",
    copy: "Kopieren",
    copied: "Kopiert!",
    pasteOffer: "Einladungs-Code hier einfügen …",
    pasteAnswer: "Antwort-Code hier einfügen …",
    acceptOffer: "Code annehmen & Antwort erzeugen",
    completeConnection: "Verbindung herstellen",
    waitingForPeer: "Warte auf Mitspieler …",
    connected: "Verbunden",
    connecting: "Verbinde …",
    disconnected: "Getrennt",
    failed: "Fehlgeschlagen",
    invalidCode: "Ungültiger Code. Bitte vollständigen Code einfügen.",
    ...
    reconnectHint: "Erzeugt neue Codes und tauscht sie erneut aus, um weiterzuspielen. Der Spielstand bleibt erhalten.",
    newOffer: "Neuen Einladungs-Code erzeugen",
    rules: "Regeln",
  ...
  en: {
    ...
    hostGame: "Host game",
    joinGame: "Join game",
    hostIntro: "Generate a code, send it to your partner, then paste their answer.",
    joinIntro: "Paste the host's code, then send your answer code back.",
    offerCode: "Your invite code",
    answerCode: "Your answer code",
    generateOffer: "Generate invite code",
    copy: "Copy",
    copied: "Copied!",
    pasteOffer: "Paste invite code here …",
    pasteAnswer: "Paste answer code here …",
    acceptOffer: "Accept code & create answer",
    ...
    failed: "Failed",
    invalidCode: "Invalid code. Please paste the complete code.",
    ...
    reconnectHint: "Generate fresh codes and exchange them again to continue. The game state is preserved.",
    newOffer: "Generate new invite code",
    rules: "Rules",
