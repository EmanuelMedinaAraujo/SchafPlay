...
export const translations = {
  de: {
    ...
    settingsCardDesign: "Kartenbild",
    settingsCardDesignHint: "Wähle das traditionelle bayerische Kartenbild oder die schlichte Symbol-Darstellung.",
    settingsCardDesignBavarian: "Bayerisch",
    settingsCardDesignMinimal: "Schlicht",
  ...
  en: {
    ...
    settingsCardDesign: "Card design",
    settingsCardDesignHint: "Choose the traditional Bavarian card faces or the plain symbol design.",
    settingsCardDesignBavarian: "Bavarian",
    settingsCardDesignMinimal: "Minimal",
