...
>
> Coverage is a **subset** of the catalogue below, not the full 71 cases — this document remains the design reference/backlog. The implemented suite is 15 spec files under `tests/e2e/`; the main ones:
>
